(function(jwplayer){
    ...
    var template = function(_player, config, _div) {    
	    ...
	    function _setupForm(){
            ...
            htmls += "<div id='popup'>";
	        htmls += "<div id='topline' style='width: 640px; height: 6px; background:url(../images/TopLine.png) repeat-x;'></div>";
	        ...
	        htmls += "<input style='width:148px;padding: 5px 4px 3px 3px;border: 1px solid #0d2c52;background-color:#1e4f8a;font-size: 16px;color: #ebebeb;' maxlength='2048' size='30' value='' title='emails' name='emails' id='emails'><input type='image' src='/images/ .png' id='buttons' name='buttons' width='70' height='25'><br><br>";
